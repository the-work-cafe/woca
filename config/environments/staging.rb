Rails.application.configure do
  ...
  config.action_mailer.default_url_options = {host: 'staging.woca.life', protocol: "https"}
  ...
  # config.active_job.queue_name_prefix = "woca_#{Rails.env}"
...
Rails.application.routes.default_url_options = { host: 'staging.woca.life' }
